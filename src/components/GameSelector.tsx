...
export interface GameSelectorProps {
  ...
  testCorrectTimeoutRef: React.MutableRefObject<ReturnType<
    typeof setTimeout
  > | null>;
    ...
    <>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex gap-2">
          {!testActive && (
            <button
              ...
              disabled={testChordPoolLength === 0}
              onClick={() => {
                setTestActive(true);
          ...
          {testActive && (
            <button
              ...
              className="rounded-md border border-amber-600/60 bg-amber-900/40 px-3 py-2 text-sm font-medium text-amber-200 hover:bg-amber-800/50 focus:outline-none focus:ring-1 focus:ring-amber-500 w-full"
            >
              Stop test
            </button>
          )}
        ...
        <fieldset
          ...
          role="radiogroup"
          aria-label="Chord types to test"
        >
